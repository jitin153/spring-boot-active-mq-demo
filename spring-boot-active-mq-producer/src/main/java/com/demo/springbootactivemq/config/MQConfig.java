...
public class MQConfig {
	...
	@Value("${active.mq.queue.name.order}")
	private String queueNameOrder;
	
	@Value("${active.mq.queue.name.messages}")
	private String queueNameMessages;
	
	  @Bean
	  public Queue queueOrder() {
		  return new ActiveMQQueue(queueNameOrder);
	  }
	  
	  @Bean
	  public Queue queueMessages() {
		  return new ActiveMQQueue(queueNameMessages);
	  }
